//product object for dispaly replace api
const loadProducts = () => {
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h4>A.V.G rating (<span class="rating">${product.rating.rate}</span>)</h4>
      <h6>${product.rating.count} People Rating this product</h6>
...
const updatePrice = (id, value) => {
  ...
  document.getElementById(id).innerText =total.toFixed(2); //to fixed for decimil number
};
